  ...
  return (
    ...
    >
      <header className="flex items-start justify-between gap-3 mb-4">
        <div className="text-sm font-medium text-neutral-500 dark:text-neutral-400 flex items-center gap-2 flex-wrap">
          <span>
          ...
          {question.source === 'generated' ? (
            <span
              ...
              title="This is a generated practice question, not from a past exam paper"
            >
              practice
            </span>
          ) : null}
