    ...
    >
        ...
        <div className="text-sm font-medium text-neutral-500 dark:text-neutral-400">
          ...
          {question.topic ? (
            <>
              ...
              <span className="text-neutral-700 dark:text-neutral-300">{question.topic}</span>
            </>
          ) : null}
        </div>
      </header>
      ...
      <div className="space-y-3" role="radiogroup" aria-label="Answer options">
        {question.options.map((opt) => {
          ...
          const isCorrect = showCorrect && opt.id === question.correctOptionId;
      ...
      {question.explanation ? (
        <div className="mt-5">
          ...
          {showExplanation ? (
            <div className="mt-2 rounded-xl bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 p-4 text-sm leading-relaxed animate-slide-up">
              {question.explanation}
            </div>
          ) : null}
        </div>
