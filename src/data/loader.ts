...
/**
 * Returns counts of real vs generated questions for a given exam-subject.
 * Used by the UI to show how much of the pool is past-exam vs practice.
 */
export function countBySource(
  ...
  let generated = 0;
  for (const q of all) {
    if (q.source === 'generated') generated += 1;
    else real += 1;
  }
  return { real, generated, total: all.length };
}
