...
const Flashcards = lazy(() =>
  import('./routes/Flashcards').then((m) => ({ default: m.Flashcards })),
);
...
export function App() {
  ...
  // Handle GitHub Pages SPA routing: restore original path from 404.html redirect
  useEffect(() => {
      ...
      <ErrorBoundary>
        <Suspense fallback={<RouteLoading />}>
          <Routes>
            ...
            <Route path="/flashcards/:examId/:subjectId" element={<FlashcardDeck />} />
